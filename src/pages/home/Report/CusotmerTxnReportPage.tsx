...
import { useGetAllTxnByCustomerQuery, useGetCustomerByIdQuery } from "../../../redux/features/customer/customerApi";
...
const CusotmerTxnReportPage = () => {
    ...
    const { data, isLoading } = useGetAllTxnByCustomerQuery({ id, startDate, endDate });
...
export default CusotmerTxnReportPage;