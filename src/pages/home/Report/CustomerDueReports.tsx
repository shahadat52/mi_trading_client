...
const CustomerDueReports = () => {
    ...
    const totalPayable = customers?.reduce((sum: number, item: any) => sum + item.totalDue, 0);
        ...
        <div className="min-h-screen p-4 mx-auto">
            ...
            >
                ...
                <table className="w-full border-collapse mt-5">
                    ...
                    <tbody>
                        {
                            customers && customers?.map((txn: any, index: number) => (
                                <tr key={index}>
                    ...
                    <tfoot>
                        <tr className="font-bold bg-gray-100">
                            ...
                            <td className="border p-2 text-right">{totalPayable}</td>
                        </tr>
                    </tfoot>
                </table>
