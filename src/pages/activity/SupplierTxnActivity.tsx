...
import { useGetAllSupplierTxnQuery } from "../../redux/features/supplierTxn/supplierTxnApi";

const SupplierTxnActivity = ({ startDate, endDate }: any) => {
    const { data, isLoading, isError } = useGetAllSupplierTxnQuery({ startDate, endDate })
            ...
            <div className=" bg-white rounded-xl shadow overflow-hidden mb-16">
                ...
                {!isLoading && !isError && transactions?.length === 0 && (
                    <div className="py-10 text-center text-gray-500 text-sm">
                        No transactions found for Suppliers
                    </div>
                )}
...
export default SupplierTxnActivity;