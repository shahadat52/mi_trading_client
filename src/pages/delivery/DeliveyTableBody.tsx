...
const DeliveryTableBody = ({ d, openDeliverySlip, }: { d: TDelivery; openDeliverySlip: any; }) => {
    ...
    return (
        <tr className="hover:bg-gray-50">
            ...
            <td onClick={() => navigate(`/upload/${d._id}`)} className="px-1 py-1 border">
                <button className='flex justify-center items-center'>  <span>Upload </span><span className='text-4xl'><IoMdCloudUpload /></span></button>
            </td>
        </tr >
    );
};
