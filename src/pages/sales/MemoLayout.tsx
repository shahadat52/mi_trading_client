...
const MemoLayout: React.FC<{ sale: any | null; onClose: () => void }> = ({ sale, onClose }) => {
    ...
    return (
        <div>
            {
                sale.status === 'paid' ? <div className="fixed  inset-0 z-50 flex  items-start justify-center overflow-auto  bg-black/40 min-h-screen  p-4 ">
                    ...
                    <div className="fixed  inset-0 z-50 flex  items-start justify-center overflow-auto  bg-black/40 min-h-screen  p-4 ">
                        ...
                        <div className=" border max-w-3xl rounded  overflow-auto print-area w-[520px] bg-white  border-black shadow-lg ">
                            ...
                            <div className=' shadow-lg '>
                                <div className="grid grid-cols-12 pb-4 text-center text-black ">
                                    ...
                                    <div className="col-span-1 text-[8px]  border rounded-bl-full   bg-red-800 text-white   pt-4 ">
                                        {sale?.status === "paid" ? '' : <span> অরিজিনাল মেমো</span>}
                                    </div>
                                </div>
