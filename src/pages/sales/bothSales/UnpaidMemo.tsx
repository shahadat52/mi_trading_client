                ...
                <div className=" border max-w-3xl rounded  overflow-auto print-area  bg-white  border-black shadow-lg ">
                    ...
                    <div className=' shadow-lg '>
                        <div className="grid grid-cols-12  text-center text-black ">
                            ...
                            <div className="vertical-text pl-4 col-span-1 text-[14px] h-48 border rounded-bl-full   bg-red-800 text-white    ">
                    ...
                    <div className="p-4 text-sm">
                        ...
                        <div className=" my-2 flex justify-between">
                            <div className='' > নাম: <span className="shadow px-4 ">{sale?.customer?.name}</span> </div>
                        ...
                        <tbody className="my-section h-auto align-top overflow-hidden">
                            ...
                            {sale.items?.map((p: any, idx: number) => (
                                <tr key={idx} className="relative border-b border-gray-100">
                                    ...
                                    <td className="border-r text-center border-gray-300 p-1 ">{p.salePrice} </td>
                                    <td className="p-1 text-center">{p?.salePrice * p?.quantity} </td>
                                </tr>
                            ))}
                        </tbody>
                        <tfoot>
                    ...
                    </table>
                    {
                        sale.status === 'unpaid' || 'partial' ? <div className="text-sm text-start text-red-700 leading-tight">
                            <p className='py-[2px] text-sm'>মন্তব্যঃ {sale?.comments}</p>
                        </div> : ''
                    }
