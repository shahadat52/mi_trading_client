...
import { useDeleteSalesInvoiceMutation, useGetAllDueSalesQuery } from '../../../redux/features/cart/cartApi';
...
const DueSalesPage = () => {
    ...
    const { data, isLoading, isError, error } = useGetAllDueSalesQuery({ page, limit, search: debouncedSearch, order, sortBy, dateFrom, dateTo });
