...
const CheckoutPage = () => {
    ...
    // কম্পোনেন্ট লোড হওয়ার সময় এবং পণ্যের লিস্ট পরিবর্তন হলে grandTotal ক্যালকুলেট করার জন্য
    useEffect(() => {
        dispatch(calculateGrandTotal());
    }, [dispatch, products, cart.labour, cart.customerCommission, cart.others]);
    ...
    // Redux থেকে আসা grandTotal এর সাথে কমিশন যোগ করে ফাইনাল grandTotal হিসাব করা
    const grandTotal = Math.round(totalCommission + Number(cart.grandTotal || 0));
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 ">
                    ...
                    <div className="lg:col-span-2 space-y-1">
                        <div>
                            <div className="overflow-x-auto">
                                        ...
                                        {products?.map((product: any, idx: number) => (
                                            <tr key={idx} className=" hover:bg-gray-50">
                                                ...
                                                <td className="px-2 py-2">
                                                    <input
                                                        type="number"
                                                        className="input w-16 border rounded px-2 py-1 text-center"
                                                        value={product.bosta}
                                                        onChange={(e) => {
                                                            dispatch(updateBosta({ productId: product.product, bosta: Number(e.target.value) }));
                                                        }}
                                                    />
                                                </td>
                                                ...
                                                <td className="px-2">
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            dispatch(updateSalePrice({ productId: product.product, salePrice: Number(e.target.value) }));
                                                            dispatch(calculateGrandTotal());
                                                        }}
                                                    />
                                                </td>
                                                ...
                                                <td className="px-2">
                                                    ৳ {Number(Number(product.quantity || 0) * Number(product.salePrice || 0))}
                                                </td>
                                ...
                                <p className="text-end mr-[10%] lg:mr-[18%] mt-2">মোটঃ {subTotal}</p>
                        ...
                        <div>
                            <div className="flex items-center justify-end w-full mt-3 mb-[-12px]">
                                <button onClick={() => setIsOpen(true)} className="text-2xl flex px-2 rounded">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <section>
                                    <SearchableSelectField
                                        ...
                                        onSelect={(customer) => dispatch(setCustomer({ _id: customer?._id, name: customer?.name }))}
                                        displayKeys={{ title: "name", subtitle: "address", optional: "phone" }}
                                    />
                                </section>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div className="col-span-2">
                                        <SearchableSelectField
                                            ...
                                            onSelect={(broker) => dispatch(setBrokerName({ _id: broker._id, name: broker.name }))}
                                            displayKeys={{ title: "name", subtitle: "phone" }}
                                        />
                                    </div>
                                    <div className="col-span-1">
                                        <label className="mb-[2px] block text-sm font-medium text-gray-700">ব্রোকারি</label>
                                        <CalculatorField
                                            initialValue={cart.brokerBill}
                                            onUpdate={(val) => dispatch(setBrokerBill(val))}
                                        />
                                    </div>
                                </div>

                                <div>
                                    <label>কাস্টমার কমিশন</label>
                                    <CalculatorField
                                ...
                                <div>
                                    <label className="mb-1 block text-sm font-medium text-gray-700">পেমেন্ট মেথড</label>
                                    <select
                                ...
                                {paymentMethod === 'bank' && (
                                    <div>
                                        <label className="mb-1 block text-sm font-medium text-gray-700">ব্যাংকের নাম</label>
                                        <select
                                            {...register("bankName", {
                    ...
                    <div className="bg-white rounded-xl shadow p-4 h-fit">
                        ...
                        <button
                            onClick={handleSales}
                            className="w-full mt-6 bg-black text-white py-3 rounded-lg hover:bg-gray-800 transition flex justify-center items-center"
                        >
