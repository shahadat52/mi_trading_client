                        ...
                        <tbody>
                            {fieldWiseData?.map((data: any) => (
                                <tr key={data._id}>
                                    <td>{data.invoice}</td>
                                    <td className="text-right">
                                        {Number(data.tohori).toLocaleString()}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
